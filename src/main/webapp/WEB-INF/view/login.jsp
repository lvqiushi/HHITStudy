...
%>
	...
	<div class="cent-box">
		...
		<div class="cont-main clearfix">
			...
			<form action="login" method="post" >
					...
					<div class="group">
						...
						<div class="col-sm-9">
							<label class="radio-inline"> <input type="radio"
								checked="" value="student" id="optionsRadios1"
								name="usertype">学生
							</label> <label class="radio-inline"> <input type="radio"
								value="teacher" id="optionsRadios2" name="usertype">教师
							</label>
						</div>
					</div>
				</div>
				...
				<div class="button">
					<button type="submit" class="login-btn register-btn" id="button" onclick="jiami()">登录</button>
				</div>
	...
	<div class="footer">
		...
		<p>
			Designed By ZengRong & <a href="zrong.me">mycodes.net</a> 2016
		</p>
	</div>

...
<form class="form-horizontal" role="form" action="AddChapter" target="_parent" method="post"> 
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <input type="text" name="chapterTitle"  class="form-control" id="add-course-title2" placeholder="章节标题" required>
        </div>
    </div>
    <div class="form-group">
        <label for="add-course-summary2" class="col-sm-2 control-label">章节概述</label>
        <div class="col-sm-10">
            <textarea class="form-control" name="chapterInfor" rows="4" id="add-course-summary2" placeholder="章节概述" required></textarea>
        </div>
    </div>
    <div class="form-group">

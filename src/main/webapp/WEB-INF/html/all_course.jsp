            ...
            <div class="col-sm-3" style="padding-right: 30px">
                <div class="row all-course-list text-center">
                    <div class="list-group">
                        <a href="ShowCourseInfor?type=0" id="ac-all" class="list-group-item">全部</a>
                        <a href="ShowCourseInfor?type=1" id="ac-jsj" class="list-group-item">计算机</a>
                        <a href="ShowCourseInfor?type=2" id="ac-wy" class="list-group-item">外语</a>
                        <a href="ShowCourseInfor?type=3" id="ac-wxls" class="list-group-item">文学历史</a>
                        <a href="ShowCourseInfor?type=4" id="ac-gx" class="list-group-item">工学</a>
                        <a href="ShowCourseInfor?type=5" id="ac-lx" class="list-group-item">理学</a>
                    </div>
                </div>
            </div>
                ...
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane active" id="course-hot">
                        ...
                        <nav aria-label="Page navigation" class="text-center"  id="page">
			                <ul class="pagination">
			                	<li><a href="ShowCourseInfor?curpage=1&type=${type}&kind=${kind}">首页</a> </li>
			                	
			                	<c:if test="${curpage>1}">
			                		<li>
			                        	<a href="ShowCourseInfor?curpage=${curpage-1}&type=${type}&kind=${kind}" aria-label="Previous">
							...
							<c:forEach begin="${pagebean.star}" end="${pagebean.end}" var="i">
								...
								<c:if test="${curpage!=i}">
									<li><a
										href="ShowCourseInfor?curpage=${i}&type=${type}&kind=${kind}"
							...
							<c:if test="${pagebean.curPage<pagebean.pageCount}">
			                		<li>
			                        	<a href="ShowCourseInfor?curpage=${curpage+1}&type=${type}&kind=${kind}" aria-label="Next">
			                            	<span aria-hidden="true">&raquo;</span>
			                        	</a>
			                   		</li>
								</c:if> 
								<li><a href="ShowCourseInfor?curpage=${pagebean.pageCount}&type=${type}&kind=${kind}">末页</a> </li>
			                </ul>
			            </nav>
			            </c:if>
                    </div>
...
function foward() {
	window.location.href='ShowCourseInfor?kind=1&type=${type}';      
}
function foward1() {
	window.location.href='ShowCourseInfor?kind=2&type=${type}';      
}
</script>
</body>
</html>
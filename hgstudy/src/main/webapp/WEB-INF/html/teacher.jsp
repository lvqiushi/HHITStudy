...
<article class="container">
    <div class="row info-row">
        <div class="col-xs-3  head-img">
        	<div class="row">
        		<div class="col-md-6 col-sm-12">
                    <a id="teacher-head-btn" href="#avatar-modal" data-toggle="modal"><img class="img-responsive img-rounded" id="teacherHeader" src="${user.teaimage }" title="点击修改头像" alt=""></a>
                </div>
	            <div class="col-md-6">
	            	<br>
		            <h3>${user.teaName }</h3>
		            <h5>${user.teaSchool }</h5><br>
       			</div>
       		</div>
       		<div class="info-btn">
	       		<a type="button" id="teacher-profile-btn" onclick="click2('${user.teaId}')" class="btn btn-default btn-block">编辑信息</a><br>			    
       ...
       <div class="col-xs-9">
            <iframe id="teacher-iframe" class="iframeGroup" src="ShowCourseAction.action?curpage=1"  height="1200px" width="900px" frameborder="0" scrolling="no"></iframe>
        </div>
    </div>
</article>
	<!-- 上传头像界面 -->
...
<script>
	function click1(userid) {
		 $("#teacher-iframe").attr("src","html/touxiang4.jsp?userid="+userid)
	}
	function click2(userid) {
		$("#teacher-iframe").attr("src","ShowPersonInfor!teacher.action?userid="+userid)
	}
	function click3() {
		$("#teacher-iframe").attr("src","ShowCourseAction.action?curpage=0")
	}
